...
class CalleeNode():
    ...
    """
    def __init__(self, node_key: str, block_key: str, callee_name: str, param_num: int, param_type: list, dataset_name: str) -> None:
    ...
    def get_key(self) -> str:
        ...
        """
        return self.dataset_name + '-' + self.callee_name + '-' + str(self.param_num)
