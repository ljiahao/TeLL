...
from util.common import cpg_edge_type
from util.data_structure import Queue, Stack
from util.setting import logger
from fast.ddg_node import DDGNode
...
def merge_def_use(cfg_cpg: DiGraph = None, node: str = None) -> DDGNode:
    ...
    return DDGNode(node, cfg_cpg.nodes[node]['cpg_node'].node_type, defs, uses, unknown)
